...
<xsl:template match="ns7:Etapa">
    <Etapa>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="etapaIdentifikator">
		<xsl:value-of select="ns7:etapaIdentifikator"/>
	</xsl:attribute>
	<xsl:attribute name="etapaNazev">
		<xsl:value-of select="ns7:etapaNazev"/>
	</xsl:attribute>
	<xsl:attribute name="poznamka">
