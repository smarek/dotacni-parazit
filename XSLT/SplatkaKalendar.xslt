...
<xsl:template match="ns7:SplatkaKalendar">
    <SplatkaKalendar>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="castkaSplatkaPlanovana">
		<xsl:value-of select="ns7:castkaSplatkaPlanovana"/>
	</xsl:attribute>
	<xsl:attribute name="castkaSplatkaSkutecna">
		<xsl:value-of select="ns7:castkaSplatkaSkutecna"/>
	</xsl:attribute>
	<xsl:attribute name="uroceniIndikator">
		<xsl:value-of select="ns7:uroceniIndikator"/>
	</xsl:attribute>
