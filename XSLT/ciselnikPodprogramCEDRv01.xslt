...
<xsl:template match="ns15:Podprogram">
    <ciselnikPodprogramCEDRv01>
	...
	<xsl:attribute name="podprogramKod">
		<xsl:value-of select="ns15:podprogramKod"/>
	</xsl:attribute>
	<xsl:attribute name="podprogramNazev">
		<xsl:value-of select="ns15:podprogramNazev"/>
	</xsl:attribute>
