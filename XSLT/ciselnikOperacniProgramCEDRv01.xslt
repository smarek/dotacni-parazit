...
<xsl:template match="ns15:OperacniProgram">
    <ciselnikOperacniProgramCEDRv01>
	...
	<xsl:attribute name="operacaniProgramKod">
		<xsl:value-of select="ns15:operacaniProgramKod"/>
	</xsl:attribute>
	<xsl:attribute name="operacaniProgramNazev">
		<xsl:value-of select="ns15:operacaniProgramNazev"/>
	</xsl:attribute>
	<xsl:attribute name="zaznamIdentifikator">
		<xsl:value-of select="ns15:zaznamIdentifikator"/>
	</xsl:attribute>
	...
	<xsl:attribute name="operacaniProgramCislo">
		<xsl:value-of select="ns15:operacaniProgramCislo"/>
	</xsl:attribute>
    </ciselnikOperacniProgramCEDRv01>
</xsl:template>
