...
<xsl:template match="ns7:PrijemcePomoci">
    <PrijemcePomoci>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="jePrislusnikStatu">
		<xsl:value-of select="ns7:jePrislusnikStatu/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="jeRegistrovanSPravniFormou">
		<xsl:value-of select="ns7:jeRegistrovanSPravniFormou/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="obdrzelDotaci">
		<xsl:value-of select="ns7:obdrzelDotaci/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="sidliNaAdrese">
		<xsl:value-of select="ns7:sidliNaAdrese/@rdf:resource"/>
	</xsl:attribute>
	...
	<xsl:attribute name="ico">
		<xsl:value-of select="ns9:ico"/>
	</xsl:attribute>
	<xsl:attribute name="obchodniJmeno">
		<xsl:value-of select="ns9:obchodniJmeno"/>
	</xsl:attribute>
	<xsl:attribute name="legalName">
		<xsl:value-of select="ns12:legalName"/>
	</xsl:attribute>
	<xsl:attribute name="maTrvaleBydlisteNaAdrese">
		<xsl:value-of select="ns7:maTrvaleBydlisteNaAdrese/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="jmeno">
		<xsl:value-of select="ns10:jmeno"/>
	</xsl:attribute>
	<xsl:attribute name="prijmeni">
		<xsl:value-of select="ns10:prijmeni"/>
	</xsl:attribute>
	<xsl:attribute name="narozeniRok">
		<xsl:value-of select="ns11:narozeniRok"/>
	</xsl:attribute>
	<xsl:attribute name="firstName">
		<xsl:value-of select="ns13:firstName"/>
	</xsl:attribute>
	<xsl:attribute name="lastName">
		<xsl:value-of select="ns13:lastName"/>
	</xsl:attribute>
	<xsl:attribute name="dic">
		<xsl:value-of select="ns9:dic"/>
	</xsl:attribute>
    </PrijemcePomoci>
</xsl:template>
