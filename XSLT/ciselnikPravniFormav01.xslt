...
<xsl:template match="ns19:PravniForma">
    <PravniForma>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="pravniFormaCiselnikAxisPravniFormaKod">
		<xsl:value-of select="ns19:pravniFormaCiselnikAxisPravniFormaKod/@rdf:resource"/>
	</xsl:attribute>
	...
	<xsl:attribute name="pravniFormaKod">
		<xsl:value-of select="ns9:pravniFormaKod"/>
	</xsl:attribute>
	<xsl:attribute name="pravniFormaNazev">
		<xsl:value-of select="ns9:pravniFormaNazev"/>
	</xsl:attribute>
	<xsl:attribute name="pravniFormaNazevZkraceny">
		<xsl:value-of select="ns9:pravniFormaNazevZkraceny"/>
	</xsl:attribute>
	<xsl:attribute name="pravniFormaTypKod">
		<xsl:value-of select="ns9:pravniFormaTypKod"/>
	</xsl:attribute>
    </PravniForma>
</xsl:template>
