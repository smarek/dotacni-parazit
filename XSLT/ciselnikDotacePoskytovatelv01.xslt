...
<xsl:template match="ns7:DotacePoskytovatel">
    <cDotacePoskytovatelV01>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="dotacePoskytovatelCiselnikAxisDotacePoskytovatelKod">
		<xsl:value-of select="ns7:dotacePoskytovatelCiselnikAxisDotacePoskytovatelKod/@rdf:resource"/>
	</xsl:attribute>
	...
	<xsl:attribute name="dotacePoskytovatelKod">
		<xsl:value-of select="ns6:dotacePoskytovatelKod"/>
	</xsl:attribute>
	<xsl:attribute name="dotacePoskytovatelNazev">
		<xsl:value-of select="ns6:dotacePoskytovatelNazev"/>
	</xsl:attribute>
