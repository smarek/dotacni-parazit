...
<xsl:template match="ns16:Program">
    <ciselnikProgramv01>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="programKod">
		<xsl:value-of select="ns16:programKod"/>
	</xsl:attribute>
	<xsl:attribute name="programNazev">
		<xsl:value-of select="ns16:programNazev"/>
	</xsl:attribute>
	<xsl:attribute name="zaznamIdentifikator">
		<xsl:value-of select="ns16:zaznamIdentifikator"/>
	</xsl:attribute>
