...
<xsl:template match="ns7:RozpoctoveObdobi">
    <RozpoctoveObdobi>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="castkaCerpana">
		<xsl:value-of select="ns7:castkaCerpana"/>
	</xsl:attribute>
	<xsl:attribute name="castkaSpotrebovana">
		<xsl:value-of select="ns7:castkaSpotrebovana"/>
	</xsl:attribute>
	<xsl:attribute name="castkaUvolnena">
		<xsl:value-of select="ns7:castkaUvolnena"/>
	</xsl:attribute>
	<xsl:attribute name="dotaceTitul">
		<xsl:value-of select="ns7:dotaceTitul/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="refRozpoctoveObdobi">
		<xsl:value-of select="ns7:refRozpoctoveObdobi/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="rozpocetObdobi">
		<xsl:value-of select="ns7:rozpocetObdobi"/>
	</xsl:attribute>
	<xsl:attribute name="ucelZnak">
		<xsl:value-of select="ns7:ucelZnak/@rdf:resource"/>
	</xsl:attribute>
	...
	<xsl:attribute name="castkaVracena">
		<xsl:value-of select="ns7:castkaVracena"/>
	</xsl:attribute>
    </RozpoctoveObdobi>
</xsl:template>
