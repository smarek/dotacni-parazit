...
<xsl:template match="ns15:GrantoveSchema">
    <ciselnikGrantoveSchemaCEDRv01>
	...
	<xsl:attribute name="grantoveSchemaCislo">
		<xsl:value-of select="ns15:grantoveSchemaCislo"/>
	</xsl:attribute>
	<xsl:attribute name="grantoveSchemaKod">
		<xsl:value-of select="ns15:grantoveSchemaKod"/>
	</xsl:attribute>
	<xsl:attribute name="grantoveSchemaNazev">
		<xsl:value-of select="ns15:grantoveSchemaNazev"/>
	</xsl:attribute>
