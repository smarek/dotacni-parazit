...
<xsl:template match="ns7:UcelZnak">
    <ciselnikUcelZnakv01>
	...
	<xsl:attribute name="ucelZnakCiselnikAxisUcelZnakKod">
		<xsl:value-of select="ns7:ucelZnakCiselnikAxisUcelZnakKod/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="zaznamDatumPlatnostDo">
		<xsl:value-of select="ns7:zaznamDatumPlatnostDo"/>
	</xsl:attribute>
	<xsl:attribute name="zaznamDatumPlatnostOd">
		<xsl:value-of select="ns7:zaznamDatumPlatnostOd"/>
	</xsl:attribute>
	<xsl:attribute name="statniRozpocetKapitolaKod">
		<xsl:value-of select="ns6:statniRozpocetKapitolaKod"/>
	</xsl:attribute>
	<xsl:attribute name="ucelZnakKod">
		<xsl:value-of select="ns6:ucelZnakKod"/>
	</xsl:attribute>
	<xsl:attribute name="ucelZnakNazev">
		<xsl:value-of select="ns6:ucelZnakNazev"/>
	</xsl:attribute>
