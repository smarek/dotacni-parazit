...
<xsl:template match="ns2:Stat">
    <Stat>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="statKod3Cisla">
		<xsl:value-of select="ns1:statKod3Cisla"/>
	</xsl:attribute>
	<xsl:attribute name="statKod3Znaky">
		<xsl:value-of select="ns1:statKod3Znaky"/>
	</xsl:attribute>
	<xsl:attribute name="statKodOmezeny">
		<xsl:value-of select="ns1:statKodOmezeny"/>
	</xsl:attribute>
	<xsl:attribute name="statNazev">
		<xsl:value-of select="ns1:statNazev"/>
	</xsl:attribute>
	<xsl:attribute name="statNazevZkraceny">
		<xsl:value-of select="ns1:statNazevZkraceny"/>
	</xsl:attribute>
	<xsl:attribute name="statCiselnikAxisStatKod">
		<xsl:value-of select="ns2:statCiselnikAxisStatKod/@rdf:resource"/>
	</xsl:attribute>
	<xsl:attribute name="statNazevEn">
		<xsl:value-of select="ns2:statNazevEn"/>
	</xsl:attribute>
	<xsl:attribute name="statNazevZkracenyEn">
		<xsl:value-of select="ns2:statNazevZkracenyEn"/>
	</xsl:attribute>
