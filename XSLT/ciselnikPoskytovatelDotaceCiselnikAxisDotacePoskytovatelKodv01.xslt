...
<xsl:template match="ns7:DotacePoskytovatelCiselnikAxisDotacePoskytovatelKod">
    <ciselnikPoskytovatelDotaceCiselnikAxisDotacePoskytovatelKodv01>
	<xsl:attribute name="about">
		<xsl:value-of select="@rdf:about"/>
	</xsl:attribute>
	<xsl:attribute name="poskytovatelDotace">
		<xsl:value-of select="ns7:poskytovatelDotace/@rdf:resource"/>
	</xsl:attribute>
